...
export default function LoginPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    // Domain restriction — GLR and DRP employees only
    const ALLOWED_DOMAINS = ['glradiant.com', 'drp-co.com'];
    const domain = email.split('@')[1]?.toLowerCase();
    if (!ALLOWED_DOMAINS.includes(domain)) {
      setError('Access is restricted to GLR and DRP employees.');
      setLoading(false);
      return;
    }
          ...
          <form onSubmit={handleSignUp}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 9, color: '#a0b0c0', marginTop: 4 }}>
                @glradiant.com and @drp-co.com addresses only
              </div>
            </div>
