...
// SVG dimensions are labeled as mm but actually represent inches
// Code converts mm → px at 3.78, so we need to correct:
// HEATER_SCALE = (1/12 * GRID) / 3.78 = (20/12) / 3.78 = 0.441
